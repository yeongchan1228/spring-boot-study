...
//        given(eventService.getEvent(eventId)).willReturn(Optional.of(eventDto));
//
//        // when
...
//        given(eventService.saveEvent(dto)).willReturn(true);
//
//        // when
//        boolean result = eventService.saveEvent(dto);
//
//        // then
//        assertThat(result).isTrue();
//        then(eventService).should().saveEvent(dto);
//    }
//
//    @Test
...
//        then(eventService).should().modifyEvent(eventId, dto);
//    }
//
//    @Test
...
//        // given
//        EventDto dto = createEventDto(1L, "오후 운동", false);
//        given(eventService.modifyEvent(null, dto)).willReturn(false);
//
//        // when
...
//        then(eventService).should().modifyEvent(null, dto);
//    }
//
//    @Test
//    @DisplayName("이벤트 수정 -> false")
...
//        // given
//        Long eventId = 1L;
//        given(eventService.modifyEvent(eventId, null)).willReturn(false);
//
//        // when
...
//        // then
//        assertThat(modifyEvent).isFalse();
//        then(eventService).should().modifyEvent(eventId, null);
//
//    }
//
//    @Test
...
//        // given
//        Long eventId = 1L;
//        given(eventService.deleteEvent(eventId)).willReturn(true);
//
//        // when
...
//        // given
//        given(eventService.deleteEvent(null)).willReturn(false);
//
//        // when
